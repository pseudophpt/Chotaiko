...
namespace Chotaiko.Chart
{
    ...
    /// </summary>
    class ChotaikoChartStrum : IChotaikoChartObject
    {
        /// <summary>
        ...
        public ChotaikoChartStrum(int NoteID, TimeSpan Offset)
        {
            this.NoteID = NoteID;
            this.Offset = Offset;
        }
        ...
        {
            return new ChotaikoGameStrum(this.Offset, this.NoteID);
        }

        public IChotaikoPlayObject AsPlayObject()
        {
            return new ChotaikoPlayStrum(this.Offset);
        }
